...
def parse_arguments():
    ...
    parser.add_argument("--lr_decay", type=float, required=True)     # 学习率衰减率
    ...
    parser.add_argument("--alpha", type=float, required=False)          # Alpha
    parser.add_argument("--beta", type=float, required=False)           # Beta
    parser.add_argument("--x_drop_rate", type=float, required=False)    # X_dropout
    parser.add_argument("--z_drop_rate", type=float, required=False)    # Z_dropout
    parser.add_argument("--adj_drop_rate", type=float, required=False)  # Adj_dropout
    parser.add_argument("--edge_drop_rate", type=float, required=False) # Edge_dropput
